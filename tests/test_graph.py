...
# Helper function to load .mat data
...
def test_avg_shortest_path_wei(data):
    ...
    print("AVG PATH WEI:", avg_path_wei_actual, avg_path_wei_expected)
...
def test_transitivity_und_wei(data):
    ...
    print("HI", trans_und_wei_actual, trans_und_wei_expected)
    assert np.allclose(trans_und_wei_actual, trans_und_wei_expected, atol=1e-2)
...
def test_matching_ind_und(data):
    ...
    assert np.allclose(matching_ind_actual, matching_ind_expected, atol=1e-2)
